...
// src/components/planner/MapInterface.jsx
import React from "react";
import { APIProvider, Map, Marker } from "@vis.gl/react-google-maps";

const DEFAULT_CENTER = { lat: 20.5937, lng: 78.9629 }; // Center of India as an example

const MapApi = import.meta.env.VITE_GOOGLE_MAPS_API_KEY;

const MapInterface = ({ locations }) => {
  // If you have no locations, center on default
